...
export function AvailabilitySettings({ slots }) {
  ...
  return (
    <Card className="bg-white border border-emerald-100 rounded-2xl shadow-sm">
      <CardHeader>
        <CardTitle className="text-xl font-bold text- flex items-center">
      ...
      <CardContent>
        {!showForm ? (
              ...
              {slots.length === 0 ? (
                ...
                <div className="space-y-3">
                  {slots.map((slot) => (
                    <div
                      key={slot.id}
                      className="flex items-center p-3 rounded-md bg-purple-50 border border-emerald-100"
                    >
          ...
          <form
            ...
            className="space-y-4 border border-emerald-200 rounded-md p-4 bg-white"
          >
        ...
        <div className="mt-6 p-4 bg-purple-50 border border-emerald-100 rounded-md">

    ...
    <>
      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="text-center mb-6">
          <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-emerald-500 mb-2">
            Video Consultation
          </h1>
        ...
        {isLoading && !scriptLoaded ? (
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Publisher (You) */}
              <Card className="bg-white/90 backdrop-blur-md border border-purple-300 shadow-md">
                <CardContent className="p-0">
                  <div className="bg-purple-100/50 px-3 py-2 text-purple-600 text-sm font-medium rounded-t-lg">
                    You
                  </div>
                  <div
                    id="publisher"
              ...
              {/* Subscriber (Other) */}
              <Card className="bg-white/90 backdrop-blur-md border border-emerald-300 shadow-md">
                <CardContent className="p-0">
                  <div className="bg-emerald-100/50 px-3 py-2 text-emerald-600 text-sm font-medium rounded-t-lg">
                    Other Participant
                  </div>
                  <div
                    id="subscriber"
            ...
            <div className="flex justify-center gap-6">
              <Button
                variant="outline"
                onClick={toggleVideo}
                className={`rounded-full p-4 h-14 w-14 shadow-md transition-all ${
                  isVideoEnabled
              ...
              <Button
                variant="destructive"
                onClick={endCall}
                className="rounded-full p-4 h-14 w-14 bg-red-600 hover:bg-red-700 text-white shadow-md"
              >
                <PhoneOff />
              </Button>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Click the red button to end your consultation
              </p>
            </div>
          </div>
        )}

...
export function AppointmentCard({
  ...
  return (
    <>
      <Card className="bg-gradient-to-br from-white via-pink-50 to-purple-50 border border-pink-100/40 shadow-sm hover:shadow-md transition-all rounded-2xl">
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                <div className="h-5 w-5 text-pink-500 mr-2">
                  {otherPartyIcon}
                </div>
                <div>
            ...
            {appointment.status === "SCHEDULED" && (
              <div className="space-y-2">
                ...
                <Button
                  className="w-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-black hover:scale-[1.01] transition"
                  disabled={
            ...
            <div className="space-y-2">
              ...
              {userRole === "DOCTOR" && action === "notes" ? (
                ...
                <Textarea
                  ...
                  className="bg-white border border-pink-200/40 min-h-[100px] rounded-md shadow-sm"
                />
          ...
          <DialogFooter className="flex flex-col-reverse sm:flex-row sm:justify-between sm:space-x-2">
            <div className="flex gap-2">
              ...
              {appointment.status === "SCHEDULED" && (
                <Button
                  ...
                  className="border-red-300 text-red-600 hover:bg-red-100/40"
                >
            ...
            <Button
              ...
              className="bg-red-600 hover:bg-emerald-700"
            >
              Close
            </Button>
          </DialogFooter>
